    ...
    <v-layout row pa-5>
        ...
        <v-flex xs12 class='white elevation-2' py-5 style='border-radius: 25px; '> 
                        ...
                        <template v-slot:activator="{ on }" class='white' >
                            <v-layout row 
                                ...
                                <v-flex xs6 lg2 shrink :mt-5='$vuetify.breakpoint.smAndDown' >
                                    ...
                                    rounded @click.stop='++dialog_key; dialog = true; userMethod=methodsEnums.POST' >New Inventory</v-btn>
                                </v-flex>
                            </v-layout>
                        </template>
                ...
                <v-card-actions>
                    ...
                    <data-list 
                        :endpoint="endpoint+'/product/'+$route.params.id" 
                        :key='dl_key' 
                        @success='listSuccess' 
                        @error='listError'
                            ...
                            >   
                                ...
                                <!--<template v-slot:item.inventory_id="props">
                                    <router-link tag="div" :to="{
                                            name: 'inventory',
                                            params: { id :  props.item.inventory_id }
                                        }" 
                                        append class='clickable'>
                                        <div> {{ props.item.inventory_id }}</div>
                                    </router-link>
                                </template> -->
        ...
        formTitle () {
            //return this.editedIndex === -1 ? 'New Item' : 'Edit Item'
             switch(this.userMethod){
                ...
                case this.methodsEnums.POST : return 'New Inventory';
                case this.methodsEnums.PATCH : return 'Update Inventory';
                case this.methodsEnums.DELETE : return 'Delete Inventory';
