...
export default {
    ...
    data(){
        return {
            ...
            schema: {
                godown_id: {
                    text: 'Godown ID', // User friendly name
                    'v-validate' : "'integer'" , // validation rules
                    value : 'godown_id', // validation name identifier
                    edit_value : "'integer'", //  different for edit
                    default: 0, // default value
                    ignore: true
                },
                name: {
                    text: 'Godown Name', // User friendly name
                ...
                site_address: {
                    text: 'Godown Address', // User friendly name
                    'v-validate' : "'required|min:3|max:128'" , // validation rules
                    value : 'address', // validation name identifier
        ...
        formTitle () {
            //return this.editedIndex === -1 ? 'New Item' : 'Edit Item'
             switch(this.userMethod){
                ...
                case this.methodsEnums.POST : return 'New Godown';
                case this.methodsEnums.PATCH : return 'Update Godown';
                case this.methodsEnums.DELETE : return 'Delete Godown';
    ...
    methods: {
        ...
        actionEditItem (item) {
            ...
            this.editedItem.client_id = String(item.client_id)
        ...
        dialogSave (dialog) {
           ...
           switch(this.userMethod)
           {
                ...
                case this.methodsEnums.PATCH :  
                        ...
                        break;
                case this.methodsEnums.DELETE :  dialog.functions.remove( { godown_id: this.editedItem.godown_id } ); break;
