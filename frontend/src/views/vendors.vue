                        ...
                        <template v-slot:activator="{ on }" class='white' >
                            <v-layout row 
                                ...
                                <v-flex xs6 lg2 shrink :mt-5='$vuetify.breakpoint.smAndDown' >
                                    ...
                                    rounded @click.stop='++dialog_key; dialog = true; userMethod=methodsEnums.POST' >New Vendor</v-btn>
                                </v-flex>
                            </v-layout>
                        </template>
                        <v-card>
                                    ...
                                    <v-layout wrap v-if='userMethod == methodsEnums.POST || userMethod == methodsEnums.PATCH'>
                                        ...
                                        <v-flex xs12>
                                            <v-text-field 
                                                ...
                                                persistent-hint='required'
                                                data-vv-name='gst_no'
                                                :error-messages="errors.collect('gst_no')"
                                            ></v-text-field>
                                        </v-flex>
        ...
        formTitle () {
            //return this.editedIndex === -1 ? 'New Item' : 'Edit Item'
             switch(this.userMethod){
                ...
                case this.methodsEnums.POST : return 'New Vendor';
                case this.methodsEnums.PATCH : return 'Update Vendor';
                case this.methodsEnums.DELETE : return 'Delete Vendor';
        ...
        dialogSave (dialog) {
           ...
           switch(this.userMethod)
           {
                ...
                case this.methodsEnums.PATCH :  
                        ...
                        break;
                case this.methodsEnums.DELETE :  dialog.functions.remove( { vendor_id: this.editedItem.vendor_id } ); break;
