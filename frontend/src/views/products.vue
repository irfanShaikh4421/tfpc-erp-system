                        ...
                        <template v-slot:activator="{ on }" class='white' >
                            <v-layout row 
                                ...
                                <v-flex xs6 lg2 shrink :mt-5='$vuetify.breakpoint.smAndDown' >
                                    ...
                                    rounded @click.stop='++dialog_key; dialog = true; userMethod=methodsEnums.POST' >New Product</v-btn>
                                </v-flex>
                            </v-layout>
                        </template>
                        <v-card>
                            ...
                            <v-card-text>
                                <v-container grid-list-md>
                                    ...
                                    <v-layout wrap v-if='userMethod == methodsEnums.POST || userMethod == methodsEnums.PATCH'>
                                        ...
                                        <v-flex xs12 sm6>
                                            <v-text-field 
                                                v-model="editedItem.hsn_code" 
                                                label="Hsn Code"
                                                v-validate="'numeric'"
                                                data-vv-name='hsn'
                                                :error-messages="errors.collect('hsn')"
                                            ></v-text-field>
                                        </v-flex>
                                        ...
                                        <v-flex xs12 sm6>
                                            <v-text-field 
                                                v-model="editedItem.igst" 
                                                label="Igst"
                                                v-validate="'decimal'"
                                                data-vv-name='igst'
                                                :error-messages="errors.collect('igst')"
                                            ></v-text-field>
                                        </v-flex>
                                        <v-flex xs12 sm6>
                                            <v-text-field 
                                                ...
                                                v-validate="'decimal'"
                                                data-vv-name='cgst'
                                                :error-messages="errors.collect('cgst')"
                                            ></v-text-field>
                                        </v-flex>
                                        <v-flex xs12 sm6>
                                            <v-text-field 
                                                ...
                                                v-validate="'decimal'"
                                                data-vv-name='sgst'
                                                :error-messages="errors.collect('sgst')"
                                            ></v-text-field>
                                        </v-flex>
...
export default {
        ...
        formTitle () {
            //return this.editedIndex === -1 ? 'New Item' : 'Edit Item'
             switch(this.userMethod){
                ...
                case this.methodsEnums.POST : return 'New Product';
                case this.methodsEnums.PATCH : return 'Update Product';
                case this.methodsEnums.DELETE : return 'Delete Product';
    ...
    methods: {
        ...
        actionEditItem (item) {
            ...
            this.editedItem.unit_id = item.unit_id
        ...
        dialogSave (dialog) {
           ...
           switch(this.userMethod)
           {
                ...
                case this.methodsEnums.PATCH :  
                        ...
                        break;
                case this.methodsEnums.DELETE :  dialog.functions.remove( { product_id: this.editedItem.product_id } ); break;
