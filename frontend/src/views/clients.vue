                        ...
                        <template v-slot:activator="{ on }" class='white' >
                            <v-layout row 
                                ...
                                <v-flex xs6 lg2 shrink :mt-5='$vuetify.breakpoint.smAndDown' >
                                    ...
                                    rounded @click.stop='++dialog_key; dialog = true; userMethod=methodsEnums.POST' >New Client</v-btn>
                                </v-flex>
                            </v-layout>
                        </template>
                        <v-card>
                                    ...
                                    <v-layout wrap v-if='userMethod == methodsEnums.POST || userMethod == methodsEnums.PATCH'>
                                        ...
                                        <v-flex xs12 sm6>
                                            <v-text-field 
                                                ...
                                                data-vv-name='gst_name'
                                                :error-messages="errors.collect('gst_name')"
                                            ></v-text-field>
                                        </v-flex>
                        ...
                        <div slot-scope="{ data , error, loading }">
                            ...
                            >   
                                ...
                                <template  v-slot:item.name="props">
                                    <router-link tag="tr" :to="props.item['client_id']+''" append class='clickable' style='cursor: pointer'>
        ...
        formTitle () {
            //return this.editedIndex === -1 ? 'New Item' : 'Edit Item'
             switch(this.userMethod){
                ...
                case this.methodsEnums.POST : return 'New Client';
                case this.methodsEnums.PATCH : return 'Update Client';
                case this.methodsEnums.DELETE : return 'Delete Client';
        ...
        dialogSave (dialog) {
           ...
           switch(this.userMethod)
           {
                ...
                case this.methodsEnums.PATCH :  
                        ...
                        break;
                case this.methodsEnums.DELETE :  dialog.functions.remove( { client_id: this.editedItem.client_id } ); break;
